...
class WordPractice : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        imageAvatar.setOnClickListener{
            val intent = Intent(this@WordPractice, Profile::class.java)
            startActivity(intent)
            finish()
        }
        buttonGuessTheAnimal.setOnClickListener{
            val intent = Intent(this@WordPractice, AnimalChoose::class.java)
            startActivity(intent)
            finish()
        }
        buttonListening.setOnClickListener{
            val intent = Intent(this@WordPractice, Audition::class.java)
            startActivity(intent)
            finish()
        }
    }
